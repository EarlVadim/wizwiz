...
```
bash <(curl -s https://raw.githubusercontent.com/EarlVadim/wizwiz/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/EarlVadim/wizwiz/main/update.sh)
```
