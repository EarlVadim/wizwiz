...
```
bash <(curl -s https://raw.githubusercontent.com/RootedOne/wizwiz/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/RootedOne/wizwiz/main/update.sh)
```
