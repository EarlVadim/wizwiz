...
git clone https://github.com/wizwizdev/RootedOne/wizwiz.git /var/www/html/wizwizxui-timebot
...
if [ -z "$destination_dir" ]; then
 ...
 cd /var/www/html/
 wget -O wizwizpanel.zip https://github.com/RootedOne/wizwiz/releases/download/9.1.1/wizwizpanel.zip
